...
@InputType()
class RequestCreateNestedManyWithoutInventoriesInput {
...
export { RequestCreateNestedManyWithoutInventoriesInput as RequestCreateNestedManyWithoutInventoriesInput };

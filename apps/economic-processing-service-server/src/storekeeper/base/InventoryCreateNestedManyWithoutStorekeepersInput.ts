...
@InputType()
class InventoryCreateNestedManyWithoutStorekeepersInput {
...
export { InventoryCreateNestedManyWithoutStorekeepersInput as InventoryCreateNestedManyWithoutStorekeepersInput };
